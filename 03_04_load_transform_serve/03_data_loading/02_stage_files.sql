...
PUT file://&{repo_root}/03_04_load_transform_serve/data/customers.csv
  @BRONZE_CSV_STAGE
  AUTO_COMPRESS = FALSE
  OVERWRITE = TRUE;

PUT file://&{repo_root}/03_04_load_transform_serve/data/orders.csv
  @BRONZE_CSV_STAGE
  AUTO_COMPRESS = FALSE
  OVERWRITE = TRUE;
...
PUT file://&{repo_root}/03_04_load_transform_serve/data/malformed_orders.csv
  @BRONZE_CSV_STAGE
  AUTO_COMPRESS = FALSE
  OVERWRITE = TRUE;

PUT file://&{repo_root}/03_04_load_transform_serve/data/events.json
  @BRONZE_JSON_STAGE
  AUTO_COMPRESS = FALSE
  OVERWRITE = TRUE;

PUT file://&{repo_root}/03_04_load_transform_serve/data/device_readings.jsonl
  @BRONZE_JSON_LINES_STAGE
  AUTO_COMPRESS = FALSE
  OVERWRITE = TRUE;

-- Generate this file first with data/convert_csv_to_parquet.py.
PUT file://&{repo_root}/03_04_load_transform_serve/data/product_catalog_source.parquet
